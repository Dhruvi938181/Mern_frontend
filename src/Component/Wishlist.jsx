...
import { FaTrashAlt, FaShoppingCart, FaHeart, FaArrowLeft, FaCheckCircle } from "react-icons/fa";
      ...
      <div className="container">
        <div className="d-flex flex-wrap align-items-center justify-content-between mb-4 pb-3 border-bottom bg-white p-3 p-md-4 rounded-3 shadow-sm">
          ...
          <div className="d-flex gap-2 mt-3 mt-sm-0">
            {wishlistItems.length > 0 && (
              <button onClick={handleClearAll} className="btn btn-outline-danger btn-sm px-3 fw-semibold rounded-pill">
                Clear Wishlist
              </button>
            )}
            <Link to="/" className="btn btn-dark btn-sm px-3 fw-semibold rounded-pill d-flex align-items-center gap-2">
        ...
        {wishlistItems.length === 0 ? (
          <div className="card border-0 shadow-sm rounded-4 p-5 text-center my-4 bg-white">
            ...
            <p className="text-muted small mb-4">Explore our products and save your favorites to view them later.</p>
            <div>
                    ...
                    return (
                      <tr key={id}>
                        ...
                        <td>
                          ...
                          {item.oldPrice && <small className="text-muted text-decoration-line-through">₹{item.oldPrice}</small>}
                        </td>
                        ...
                        <td className="text-end pe-4">
                          <div className="d-flex align-items-center justify-content-end gap-2">
                            <button onClick={() => handleRemove(id)} className="btn fs-3 btn-sm rounded-2 p-2" title="Remove item">
                              <FaTrashAlt />
                            </button>
                          </div>
                        </td>
                    ...
                    <div className="d-flex gap-3">
                      ...
                      <div className="flex-grow-1">
                        <div className="d-flex justify-content-between align-items-start">
                          ...
                          <button onClick={() => handleRemove(id)} className="btn btn-link text-danger p-0 border-0">
                            <FaTrashAlt />
                          </button>
                        </div>
                        ...
                        <button onClick={() => handleAddToCart(item)} className="btn btn-dark btn-sm w-100 rounded-2 fw-semibold d-flex align-items-center justify-content-center gap-2">
